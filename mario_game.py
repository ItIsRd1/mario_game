...
# buttons
start = pygame.image.load(r"C:\Users\user\Desktop\VSCODE\photos\start_img.png")
exit = pygame.image.load(r"C:\Users\user\Desktop\VSCODE\photos\exit_img.png")
...
while not game_over:
    ...
    if not is_start:
        my_screen.blit(start, (250, 100))
        my_screen.blit(exit, (267, 300))
    else:
        if left:
